...
// Solid duotone glyphs: a filled base in the skill's hue, a second tone for the part that
// explains it. Where the base is a large solid shape the detail is knocked out in white;
// otherwise the lighter tone is the same hue at low alpha, so both read on either theme.
const SKILL_ICONS = {
  brief: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 2h7l5 5v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2z"/><path d="M13 2v4a2 2 0 0 0 2 2h4z" opacity=".45"/><path d="M7.5 12h9M7.5 16h6" stroke="#fff" stroke-width="1.6" stroke-linecap="round" opacity=".9"/></svg>',
  "explain-page": '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 1.8a7.2 7.2 0 0 0-4.2 13c.7.5 1.1 1.2 1.1 2h6.2c0-.8.4-1.5 1.1-2A7.2 7.2 0 0 0 12 1.8z"/><rect x="8.9" y="18.4" width="6.2" height="2.1" rx="1.05" opacity=".45"/><rect x="10.1" y="21.4" width="3.8" height="1.8" rx=".9" opacity=".45"/></svg>',
  summarize: '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="4.8" width="18" height="2.5" rx="1.25"/><rect x="3" y="10.75" width="12" height="2.5" rx="1.25" opacity=".45"/><rect x="3" y="16.7" width="15" height="2.5" rx="1.25" opacity=".45"/></svg>',
  translate: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M2.6 4h9.2v2.3H8.3v9.2H6V6.3H2.6z"/><path d="M16.4 8.6 21.8 21h-2.5l-1.1-2.7h-4.4L12.7 21h-2.5zm-.9 7.6h3l-1.5-3.7z" opacity=".45"/></svg>',
  define: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M2 4.4h6.4A3.6 3.6 0 0 1 12 8v12.3a3.1 3.1 0 0 0-3.1-3.1H2z"/><path d="M22 4.4h-6.4A3.6 3.6 0 0 0 12 8v12.3a3.1 3.1 0 0 1 3.1-3.1H22z" opacity=".45"/></svg>',
  outline: '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="4.6" cy="5.2" r="1.8"/><circle cx="4.6" cy="12" r="1.8" opacity=".45"/><circle cx="4.6" cy="18.8" r="1.8" opacity=".45"/><rect x="8.8" y="4" width="12.2" height="2.4" rx="1.2"/><rect x="8.8" y="10.8" width="12.2" height="2.4" rx="1.2" opacity=".45"/><rect x="8.8" y="17.6" width="12.2" height="2.4" rx="1.2" opacity=".45"/></svg>',
  notes: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m2.6 15.6 5.6-5.6 5.8 5.8-5.6 5.6H2.6z" opacity=".45"/><path d="M14.4 3.4a2.4 2.4 0 0 1 3.3 0l2.9 2.9a2.4 2.4 0 0 1 0 3.3l-5.8 5.8-6.2-6.2z"/></svg>',
  quiz: '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9.6"/><path d="M12 5.9a3.8 3.8 0 0 0-3.8 3.8h2.3a1.5 1.5 0 1 1 2.2 1.3c-1 .6-1.9 1.4-1.9 2.9v.6h2.3v-.5c0-.7.5-1.1 1.2-1.6A3.8 3.8 0 0 0 12 5.9z" fill="#fff" opacity=".92"/><circle cx="12" cy="17.3" r="1.35" fill="#fff" opacity=".92"/></svg>',
  glossary: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M11.8 2.3A2.2 2.2 0 0 0 10.2 1.7H4a2.3 2.3 0 0 0-2.3 2.3v6.2c0 .6.2 1.2.7 1.6l9.3 9.3a2.4 2.4 0 0 0 3.4 0l6.2-6.2a2.4 2.4 0 0 0 0-3.4z"/><circle cx="6.6" cy="6.6" r="1.9" fill="#fff" opacity=".92"/></svg>',
  "study-notes": '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 2h7.6l4.4 4.4V20a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2z"/><path d="M13.6 2v3.4a1 1 0 0 0 1 1H18z" opacity=".45"/><path d="M7.6 11h8.8M7.6 14.6h8.8M7.6 18.2h5.4" stroke="#fff" stroke-width="1.6" stroke-linecap="round" opacity=".9"/></svg>',
  flashcards: '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2.4" y="6.6" width="14.4" height="14.4" rx="2.6"/><path d="M7.6 2.6h11.8A2.6 2.6 0 0 1 22 5.2V17h-2.4V5.6a.6.6 0 0 0-.6-.6H7.6z" opacity=".45"/><path d="M6.2 12.4h6.8M6.2 16h4.4" stroke="#fff" stroke-width="1.6" stroke-linecap="round" opacity=".9"/></svg>',
  "review-form": '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7 3.4h10a2.4 2.4 0 0 1 2.4 2.4v14.4A2.4 2.4 0 0 1 17 22.6H7a2.4 2.4 0 0 1-2.4-2.4V5.8A2.4 2.4 0 0 1 7 3.4z" transform="translate(0,-1)"/><rect x="8.6" y="1.2" width="6.8" height="3.8" rx="1.4" opacity=".45"/><path d="m8.4 13.6 2.2 2.2 4.8-4.8" stroke="#fff" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" opacity=".95"/></svg>',
  "fill-form": '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2.6" y="4.6" width="18.8" height="14.8" rx="2.6"/><path d="M6.2 10.2h6.4" stroke="#fff" stroke-width="1.8" stroke-linecap="round" opacity=".9"/><path d="m13.6 14.4 2 2 4.2-4.2" stroke="#fff" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" opacity=".95"/></svg>',
  extract: '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="8.6" y="4" width="12.4" height="2.4" rx="1.2"/><rect x="8.6" y="10.8" width="12.4" height="2.4" rx="1.2" opacity=".45"/><rect x="8.6" y="17.6" width="12.4" height="2.4" rx="1.2" opacity=".45"/><path d="m2.4 5.2 1.6 1.6 2.6-2.6M2.4 12l1.6 1.6L6.6 11M2.4 18.8l1.6 1.6 2.6-2.6" stroke="currentColor" stroke-width="1.9" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  "table-csv": '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2.6" y="3.6" width="18.8" height="16.8" rx="2.6"/><path d="M2.6 9.2h18.8M2.6 14.8h18.8M9.2 3.6v16.8" stroke="#fff" stroke-width="1.5" opacity=".85"/></svg>',
  redact: '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2.6" y="8.4" width="18.8" height="7.2" rx="2"/><rect x="2.6" y="3" width="11" height="3" rx="1.5" opacity=".45"/><rect x="2.6" y="18" width="14" height="3" rx="1.5" opacity=".45"/></svg>',
  solve: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.4 20.6h4.2L19.2 9a2.5 2.5 0 0 0-3.6-3.6L4 17v3.6z"/><path d="m14.6 6.4 3.6 3.6" stroke="#fff" stroke-width="1.8" stroke-linecap="round" opacity=".9"/></svg>',
  "review-plan": '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2.6" y="4.6" width="18.8" height="17" rx="2.8"/><path d="M2.6 9.6h18.8" stroke="#fff" stroke-width="1.6" opacity=".85"/><rect x="7" y="1.8" width="2.2" height="4.6" rx="1.1" opacity=".45"/><rect x="14.8" y="1.8" width="2.2" height="4.6" rx="1.1" opacity=".45"/><circle cx="8.4" cy="14" r="1.5" fill="#fff" opacity=".9"/><circle cx="12" cy="14" r="1.5" fill="#fff" opacity=".9"/><circle cx="8.4" cy="17.8" r="1.5" fill="#fff" opacity=".9"/></svg>',
  "paper-card": '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2.4" y="4.4" width="19.2" height="15.2" rx="2.6"/><path d="M6 9.2h8M6 13h12M6 16.2h6" stroke="#fff" stroke-width="1.6" stroke-linecap="round" opacity=".9"/></svg>',
  critique: '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="10.6" cy="10.6" r="7.4"/><path d="m16.1 16.1 5 5" stroke="currentColor" stroke-width="2.6" stroke-linecap="round" opacity=".45"/><path d="M10.6 6.8v4.4" stroke="#fff" stroke-width="1.8" stroke-linecap="round" opacity=".95"/><circle cx="10.6" cy="14.2" r="1.1" fill="#fff" opacity=".95"/></svg>',
  citation: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.2 6.4h6.4v6.4c0 3.2-1.8 5.4-4.8 6.4l-.9-2.1c1.8-.7 2.7-1.8 2.7-3.1H3.2z"/><path d="M14.4 6.4h6.4v6.4c0 3.2-1.8 5.4-4.8 6.4l-.9-2.1c1.8-.7 2.7-1.8 2.7-3.1h-3.4z" opacity=".45"/></svg>',
  risks: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M10.3 3.6 1.9 18.3A2 2 0 0 0 3.6 21.3h16.8a2 2 0 0 0 1.7-3L13.7 3.6a2 2 0 0 0-3.4 0z"/><path d="M12 9.2v4.6" stroke="#fff" stroke-width="1.9" stroke-linecap="round" opacity=".95"/><circle cx="12" cy="17.2" r="1.2" fill="#fff" opacity=".95"/></svg>',
  "plain-terms": '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.4 3.4h15.2A2.4 2.4 0 0 1 22 5.8v8.8a2.4 2.4 0 0 1-2.4 2.4H9.2L4 21.6V5.8a2.4 2.4 0 0 1 .4-2.4z"/><path d="M7.6 8h8.8M7.6 11.8h5.6" stroke="#fff" stroke-width="1.7" stroke-linecap="round" opacity=".9"/></svg>',
  counter: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m3 16.4 5.4-5.4 4.6 4.6-5.4 5.4H3z" opacity=".45"/><path d="M14.2 2.8a2.3 2.3 0 0 1 3.2 0l3.2 3.2a2.3 2.3 0 0 1 0 3.2l-5 5-6.4-6.4z"/></svg>',
  deadlines: '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2.6" y="4.6" width="18.8" height="17" rx="2.8"/><path d="M2.6 9.6h18.8" stroke="#fff" stroke-width="1.6" opacity=".85"/><rect x="7" y="1.8" width="2.2" height="4.6" rx="1.1" opacity=".45"/><rect x="14.8" y="1.8" width="2.2" height="4.6" rx="1.1" opacity=".45"/><path d="M12 12.6v3.2l2.2 1.4" stroke="#fff" stroke-width="1.8" fill="none" stroke-linecap="round" stroke-linejoin="round" opacity=".95"/></svg>',
  "documents-needed": '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7 2.4h10a2.4 2.4 0 0 1 2.4 2.4v16.8A2.4 2.4 0 0 1 17 24H7a2.4 2.4 0 0 1-2.4-2.4V4.8A2.4 2.4 0 0 1 7 2.4z" transform="translate(0,-1.4)"/><rect x="8.6" y="0.6" width="6.8" height="3.8" rx="1.4" opacity=".45"/><path d="M8.4 11.6h7.2M8.4 15.2h4.8" stroke="#fff" stroke-width="1.7" stroke-linecap="round" opacity=".9"/></svg>',
  sign: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M2.4 15.4c2.6 0 4.2-9.4 6.8-9.4s-.6 9.4 1.5 9.4 2.6-4.2 4.2-4.2 1 3.1 2.6 3.1 2.1-1 3.7-1" stroke="currentColor" stroke-width="2.2" fill="none" stroke-linecap="round" stroke-linejoin="round"/><rect x="2.4" y="19.2" width="19.2" height="2.4" rx="1.2" opacity=".45"/></svg>',
  kpis: '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2.4" y="19" width="19.2" height="2.4" rx="1.2"/><rect x="4.6" y="11.6" width="4" height="6.2" rx="1.4" opacity=".45"/><rect x="10" y="6.2" width="4" height="11.6" rx="1.4"/><rect x="15.4" y="14" width="4" height="3.8" rx="1.4" opacity=".45"/></svg>',
  "check-numbers": '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3.6" y="1.8" width="16.8" height="20.4" rx="2.8"/><rect x="7" y="5.4" width="10" height="3.2" rx="1.2" fill="#fff" opacity=".9"/><circle cx="8.2" cy="12.6" r="1.25" fill="#fff" opacity=".85"/><circle cx="12" cy="12.6" r="1.25" fill="#fff" opacity=".85"/><circle cx="15.8" cy="12.6" r="1.25" fill="#fff" opacity=".85"/><circle cx="8.2" cy="17" r="1.25" fill="#fff" opacity=".85"/><rect x="10.8" y="15.8" width="5" height="2.5" rx="1.2" fill="#fff" opacity=".85"/></svg>',
  memo: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 2h7l5 5v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2z"/><path d="M13 2v4a2 2 0 0 0 2 2h4z" opacity=".45"/><path d="M7.5 12.4h9M7.5 16h5.4" stroke="#fff" stroke-width="1.6" stroke-linecap="round" opacity=".9"/></svg>'
};

const SCENARIO_ICONS = {
  study: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2.6 1.2 8.1 12 13.6l10.8-5.5z"/><path d="M5.4 11v4.6c0 2.1 3 3.8 6.6 3.8s6.6-1.7 6.6-3.8V11L12 14.4z" opacity=".45"/><path d="M21.4 9v5.2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity=".45"/></svg>',
  research: '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="10.4" cy="10.4" r="7.6"/><path d="m16.2 16.2 5 5" stroke="currentColor" stroke-width="2.8" stroke-linecap="round" opacity=".45"/><path d="M7.4 10.4h6M10.4 7.4v6" stroke="#fff" stroke-width="1.7" stroke-linecap="round" opacity=".92"/></svg>',
  contracts: '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="3.6" r="1.8"/><rect x="11" y="4.6" width="2" height="15" rx="1"/><rect x="3.4" y="6.6" width="17.2" height="2.1" rx="1.05"/><path d="M5.6 9.4 2 16.2h7.2z" opacity=".45"/><path d="M18.4 9.4 14.8 16.2H22z" opacity=".45"/><rect x="7.4" y="19.4" width="9.2" height="2.2" rx="1.1"/></svg>',
  forms: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7 2.6h10a2.6 2.6 0 0 1 2.6 2.6v15.4A2.6 2.6 0 0 1 17 23.2H7a2.6 2.6 0 0 1-2.6-2.6V5.2A2.6 2.6 0 0 1 7 2.6z" transform="translate(0,-1)"/><rect x="8.4" y="0.4" width="7.2" height="4" rx="1.5" opacity=".45"/><path d="m8.2 13.2 2.3 2.3 5-5" stroke="#fff" stroke-width="2.1" fill="none" stroke-linecap="round" stroke-linejoin="round" opacity=".95"/></svg>',
  reports: '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2.2" y="19.2" width="19.6" height="2.4" rx="1.2"/><rect x="4.2" y="10.6" width="4.2" height="7" rx="1.5" opacity=".45"/><rect x="9.9" y="4.6" width="4.2" height="13" rx="1.5"/><rect x="15.6" y="13.4" width="4.2" height="4.2" rx="1.5" opacity=".45"/></svg>'
};
