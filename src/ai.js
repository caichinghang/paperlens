...
const SKILL_ICONS = {
  ...
  "documents-needed": '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7 2.4h10a2.4 2.4 0 0 1 2.4 2.4v14.4A2.4 2.4 0 0 1 17 21.6H7a2.4 2.4 0 0 1-2.4-2.4V4.8A2.4 2.4 0 0 1 7 2.4z" fill="var(--i-olive)"/><rect x="8.6" y="1.2" width="6.8" height="3.8" rx="1.4" fill="var(--i-denim)"/><path d="M8.4 11.6h7.2M8.4 15.2h4.8" stroke="#fff" stroke-width="1.7" stroke-linecap="round" opacity=".9"/></svg>',
